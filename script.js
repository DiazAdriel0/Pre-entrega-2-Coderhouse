...
const producto1 = new Productos("Mouse Logitech G203",10000);
const producto2 = new Productos("Teclado HyperX Alloy FPS pro",15000);
const producto3 = new Productos("Auriculares ReDragon Scylla",8000);
const producto4 = new Productos("Monitor Asus TUF 144Hz",119000);
const producto5 = new Productos("Micrófono HyperX Quadcast",110000);
const producto6 = new Productos("Silla Corsair T3 Rush",270000);
...
//Acá uso el validador para que el usuario ingrese correctamente los productos que quiere
while (validador){
